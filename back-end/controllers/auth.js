  ...
  await transporter.sendMail({
    ...
    html: `<div
      ...
      ">
          ...
          grid-template-columns: 1fr;
          text-align: center;
          gap:1rem;">Your Username/Email: <b style="color: #00adb5; text-decoration: underline;">${email}</b>
        </p>
        <p style="  font-size: 20px;
          display: grid;
          gap: 8px;
          grid-template-columns: 1fr;
          text-align: center;
          gap:1rem;">Your Password: <b style="color: #00adb5; text-decoration: underline;">${password}</b>
        </p>
          <span style="font-size: 16px; text-align: center; padding-top: 15px;">Thank you for using our service.</span>
       </div>`, // html body
  });
